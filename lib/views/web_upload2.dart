...
class FileUploadApp2 extends StatefulWidget {
  String serverEndpoint;
  final String api = 'upload';

  FileUploadApp2(String protocol, String server, String port) {
    this.serverEndpoint = '$protocol://$server:$port/${this.api}';
    print(this.serverEndpoint);
  }
  @override
  _FileUploadApp2State createState() => _FileUploadApp2State();
}

class _FileUploadApp2State extends State<FileUploadApp2> {
